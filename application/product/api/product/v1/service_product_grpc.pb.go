...
const (
	ProductCatalogService_CreateProduct_FullMethodName  = "/api.product.v1.ProductCatalogService/CreateProduct"
	ProductCatalogService_ListProducts_FullMethodName   = "/api.product.v1.ProductCatalogService/ListProducts"
	ProductCatalogService_GetProduct_FullMethodName     = "/api.product.v1.ProductCatalogService/GetProduct"
	ProductCatalogService_SearchProducts_FullMethodName = "/api.product.v1.ProductCatalogService/SearchProducts"
)
...
type ProductCatalogServiceClient interface {
	CreateProduct(ctx context.Context, in *Product, opts ...grpc.CallOption) (*ListProductsResp, error)
...
func (c *productCatalogServiceClient) CreateProduct(ctx context.Context, in *Product, opts ...grpc.CallOption) (*ListProductsResp, error) {
...
type ProductCatalogServiceServer interface {
	CreateProduct(context.Context, *Product) (*ListProductsResp, error)
...
func (UnimplementedProductCatalogServiceServer) CreateProduct(context.Context, *Product) (*ListProductsResp, error) {
...
var ProductCatalogService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.product.v1.ProductCatalogService",
	...
	Metadata: "product/v1/service_product.proto",
}
