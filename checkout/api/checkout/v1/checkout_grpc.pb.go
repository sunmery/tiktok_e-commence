...
const (
	CheckoutService_Checkout_FullMethodName = "/api.checkout.v1.CheckoutService/Checkout"
)
...
var CheckoutService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.checkout.v1.CheckoutService",
	...
	Metadata: "checkout/v1/checkout.proto",
}
