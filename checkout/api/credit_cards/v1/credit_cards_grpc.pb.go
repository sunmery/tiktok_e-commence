...
const (
	...
	CreditCardsService_GetCreditCard_FullMethodName    = "/api.credit_cards.v1.CreditCardsService/GetCreditCard"
...
func (c *creditCardsServiceClient) UpdateCreditCard(ctx context.Context, in *CreditCards, opts ...grpc.CallOption) (*CardsReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CardsReply)
...
func (c *creditCardsServiceClient) GetCreditCard(ctx context.Context, in *GetCreditCardsRequest, opts ...grpc.CallOption) (*GetCreditCardsReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetCreditCardsReply)
	err := c.cc.Invoke(ctx, CreditCardsService_GetCreditCard_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCreditCardsServiceServer) UpdateCreditCard(context.Context, *CreditCards) (*CardsReply, error) {
...
func (UnimplementedCreditCardsServiceServer) GetCreditCard(context.Context, *GetCreditCardsRequest) (*GetCreditCardsReply, error) {
...
func _CreditCardsService_UpdateCreditCard_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CreditCardsServiceServer).UpdateCreditCard(ctx, req.(*CreditCards))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CreditCardsService_GetCreditCard_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCreditCardsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CreditCardsServiceServer).GetCreditCard(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CreditCardsService_GetCreditCard_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CreditCardsServiceServer).GetCreditCard(ctx, req.(*GetCreditCardsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CreditCardsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CreditCardsService_GetCreditCard_Handler,
		},
		{
