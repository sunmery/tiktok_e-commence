...
func NewHTTPServer(c *conf.Server, ac *conf.Auth, addresses *service.AddressesServiceService, logger log.Logger) *http.Server {
	...
	v1.RegisterAddressesServiceHTTPServer(srv, addresses)
	return srv
}
