...
type CartServiceClient interface {
	...
	GetCart(ctx context.Context, in *CartReq, opts ...grpc.CallOption) (*GetCartResp, error)
	EmptyCart(ctx context.Context, in *CartReq, opts ...grpc.CallOption) (*EmptyCartResp, error)
}
...
func (c *cartServiceClient) GetCart(ctx context.Context, in *CartReq, opts ...grpc.CallOption) (*GetCartResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetCartResp)
...
func (c *cartServiceClient) EmptyCart(ctx context.Context, in *CartReq, opts ...grpc.CallOption) (*EmptyCartResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type CartServiceServer interface {
	...
	GetCart(context.Context, *CartReq) (*GetCartResp, error)
	EmptyCart(context.Context, *CartReq) (*EmptyCartResp, error)
...
func (UnimplementedCartServiceServer) GetCart(context.Context, *CartReq) (*GetCartResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetCart not implemented")
}
func (UnimplementedCartServiceServer) EmptyCart(context.Context, *CartReq) (*EmptyCartResp, error) {
...
func _CartService_EmptyCart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CartServiceServer).EmptyCart(ctx, req.(*CartReq))
	}
	return interceptor(ctx, in, info, handler)
}
